...
sources = glob.glob("./src/*.c") + glob.glob("./src/sc_utils/*.c") + glob.glob("./src/apps/sc_{}/*.c".format(sys.argv[1])) + glob.glob("./src/*.cpp") + glob.glob("./src/sc_utils/*.cpp") + glob.glob("./src/apps/sc_{}/*.cpp".format(sys.argv[1]))
